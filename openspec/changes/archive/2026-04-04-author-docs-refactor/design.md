...
1. Opening paragraph explaining *what this system does for you as an author* (intent)
...
This change *is* the documentation. The following table specifies every file to be created or updated, its intended audience, and the topics it must cover.
