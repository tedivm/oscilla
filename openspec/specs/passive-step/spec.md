...
Defines the `passive` adventure step type, which applies effects and displays text automatically without any player input, and supports an optional bypass condition to skip both text and effects based on player state.
