# Spec: Web Adventure Execution

## Purpose

Defines the SSE-based endpoints that allow web clients to start, advance, abandon, and take over adventures. The adventure pipeline runs server-side; all player-facing output is streamed as Server-Sent Events.
