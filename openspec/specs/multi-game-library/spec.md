...
Defines how the game engine discovers and loads multiple game packages from a shared library root directory, enabling a single installation to host multiple independent games.
