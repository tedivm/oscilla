# Spec: Web Session Locking

## Purpose

Defines the session locking mechanism that prevents two browser sessions from running the adventure pipeline concurrently for the same character. Covers lock acquisition, staleness, 409 conflict responses, takeover, and lock release.
