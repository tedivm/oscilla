...
Defines the extended set of dice, pool, and display helper functions available in all Jinja2 template evaluation contexts in Oscilla. These functions are registered in SAFE_GLOBALS and accessible in all adventure templates, effect amounts, stat formulas, and condition expressions.
