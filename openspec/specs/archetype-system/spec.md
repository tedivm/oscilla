...
The archetype system provides a first-class, persistent character state primitive. Archetypes are named states (e.g., Warrior, Scholar, Guild Member) granted and revoked by effects. While held, an archetype continuously applies passive stat bonuses and skill grants. The system replaces the previous Class placeholder with a fully functional implementation.
