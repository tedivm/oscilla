...
from oscilla.services.jinja import env, response_templates
...
class TestJinja2Templates:
    ...
    def test_response_templates_exists(self) -> None:
    ...
    def test_response_templates_has_env(self) -> None:
    ...
    def test_response_templates_uses_custom_env(self) -> None:
...
class TestTemplateLoader:
    ...
    def test_loader_configured_for_package(self) -> None:
        """Test that loader is configured for the package."""
        from jinja2 import PackageLoader

        assert isinstance(env.loader, PackageLoader)

    def test_loader_package_name(self) -> None:
        """Test that loader is configured with correct package name."""
        from jinja2 import PackageLoader

        # Ensure we have the right loader type
        assert isinstance(env.loader, PackageLoader)
        assert env.loader.package_name == "oscilla"


class TestTemplateRendering:
    """Test template rendering functionality."""

    def test_simple_template_rendering(self) -> None:
...
class TestAutoescaping:
    ...
    def test_autoescape_escapes_html(self) -> None:
    ...
    def test_autoescape_prevents_xss(self) -> None:
...
class TestTemplateIntegration:
    ...
    def test_response_templates_can_render(self) -> None:
    ...
    def test_response_templates_directory_configured(self) -> None:
