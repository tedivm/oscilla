...
- **`oscilla/conf/settings.py`**: Main Settings class
- **`oscilla/conf/cache.py`**: Cache-specific settings
- **`oscilla/conf/db.py`**: Database settings
- **`oscilla/settings.py`**: Global settings instance
