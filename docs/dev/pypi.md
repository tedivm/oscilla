...
ls dist/
# oscilla-1.2.3.tar.gz
# oscilla-1.2.3-py3-none-any.whl
```
...
# Install from wheel
pip install dist/oscilla-*.whl

# Verify installation
python -c "import oscilla; print(oscilla.__version__)"
...
1. Go to your project page: `https://pypi.org/project/oscilla/`
...
```bash
# View on PyPI
open https://pypi.org/project/oscilla/
