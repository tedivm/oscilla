...
- Installed with `pip install oscilla`
...
- Installed with `pip install oscilla[dev]`
...
# Creates:
# dist/oscilla-X.Y.Z.tar.gz (source)
# dist/oscilla-X.Y.Z-py3-none-any.whl (wheel)
```
