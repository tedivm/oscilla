...
Templates are stored in the `oscilla/templates/` directory:
...
The Jinja2 environment is configured in `oscilla/services/jinja.py`:
...
env = Environment(
    loader=PackageLoader("oscilla", "templates"),
...
app = FastAPI()
templates = Jinja2Templates(directory="oscilla/templates")
...
```python
# oscilla/services/jinja.py
from jinja2 import Environment, PackageLoader
from datetime import datetime

env = Environment(loader=PackageLoader("oscilla", "templates"))
...
```python
# oscilla/services/jinja.py
from oscilla.conf import settings
...
```python
from oscilla.celery import celery
from oscilla.services.jinja import env
