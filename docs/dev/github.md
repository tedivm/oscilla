...
python -c "from oscilla._version import version; print(version)"
...
docker pull ghcr.io/tedivm/oscilla.www:main
...
services:
  www:
    image: ghcr.io/tedivm/oscilla.www:v1.2.3
```
