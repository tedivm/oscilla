...
Ready-made patterns for common authoring challenges. Each recipe shows a complete working example you can adapt for your own game.
...
_These examples assume you're already familiar with the core documentation. If you're just getting started, begin with [Getting Started](../getting-started.md)._
